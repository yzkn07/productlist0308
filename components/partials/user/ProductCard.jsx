...
export default function ProductCard({ product, alisVeris }) {
    ...
    return (
        <div onClick={handleCardClick} 
            ...
            <h1 className={` bg-slate-300/30 rounded-md min-h-16 flex justify-center items-center text-clip overflow-clip py-1 w-full font-bold ${alisVeris ? " text-xl" : " text-sm"} sm:text-lg xl:text-xl`}>{product.title}</h1>
