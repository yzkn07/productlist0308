...
export default function ProductCard({ product, alisVeris }) {
    ...
    return (
        <div onClick={handleCardClick} 
            className="col-span-6 sm:col-span-6 md:col-span-4  xl:col-span-3 mb-3 mt-2 mx-auto text-white bg-gradient-to-t from-gray-300 to-gray-100 py-3 px-2 w-11/12 rounded-md  shadow-xl flex gap-5 flex-col text-center justify-center items-center cursor-pointer">
            <h1 className={` bg-slate-300/70 rounded-md min-h-16 flex justify-center items-center text-clip overflow-clip py-1 w-full font-bold ${alisVeris ? " text-xl" : " text-sm"} sm:text-lg xl:text-xl`}>{product.title}</h1>
